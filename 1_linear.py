...
X_train_new_1=feature_transform(X_train_f1,horizontal_symmetry,vertical_symmetry,order='linear')
X_train_new_5=feature_transform(X_train_f5,horizontal_symmetry,vertical_symmetry,order='linear')
X_test_new_1=feature_transform(X_test_f1,horizontal_symmetry,vertical_symmetry,order='linear')
X_test_new_5=feature_transform(X_test_f5,horizontal_symmetry,vertical_symmetry,order='linear')
...
print()
print(f"Etest for PLA with pocket is {(1-calc_acc(w_pp, [X_test_2,Y_test_2]))*100}%")
...
plot_with_separation(X_train_new_1,X_train_new_5,w_pp,order='linear',alg='PLA with pocket',dataset='train')
plot_with_separation(X_train_new_1,X_train_new_5,w_log,order='linear',alg='Logistic regression with GD',dataset='train')
plot_with_separation(X_train_new_1,X_train_new_5,w_sgd,order='linear',alg='Logistic regression with SGD',dataset='train')
plot_with_separation(X_train_new_1,X_train_new_5,w_lp,order='linear',alg='Logistic regression with Linear Programming',dataset='train')

print("plotting decision boundary on test data")
plot_with_separation(X_test_new_1,X_test_new_5,w_pp,order='linear',alg='PLA with pocket',dataset='test')
plot_with_separation(X_test_new_1,X_test_new_5,w_log,order='linear',alg='Logistic regression with GD',dataset='test')
plot_with_separation(X_test_new_1,X_test_new_5,w_sgd,order='linear',alg='Logistic regression with SGD',dataset='test')
plot_with_separation(X_test_new_1,X_test_new_5,w_lp,order='linear',alg='Logistic regression with Linear Programming',dataset='test')
